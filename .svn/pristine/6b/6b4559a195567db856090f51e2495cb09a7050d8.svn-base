...
;(function (root, factory) {
    ...
    k.fk = function (a, b) {
        ...
        var c = tc(this, qc("EPSG:4326")), d = [b[0] - a / 2, b[1], b[0] + a / 2, b[1], b[0], b[1] - a / 2, b[0], b[1] + a / 2], d = c(d, d, 2), c = (jc.b(d.slice(0, 2), d.slice(2, 4)) + jc.b(d.slice(4, 6), d.slice(6, 8))) / 2, d = this.dc();
        void 0 !== d && (c /= d);
        return c
    };
    ...
    function Xc(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        for (var q = n ? n : [NaN, NaN], t = b + d; t < c;)if (Uc(a, t - d, t, d, g, h, q), p = ma(g, h, q[0], q[1]), p < m) {
            m = p;
    ...
    function fd(a, b, c, d, e, f, g, h) {
        ...
        for (m = c.length; l < m; ++l) {
            var n = c[l];
            a:{
                var p = a, q = n, t = d, u = e, y = f;
                if (b != q) {
                    var x = u * Math.round(p[b] / u), C = u * Math.round(p[b + 1] / u);
                    b += t;
                    y[g++] = x;
                    y[g++] = C;
                    var z, K;
                    do if (z = u * Math.round(p[b] / u), K = u * Math.round(p[b + 1] / u), b += t, b == q) {
                        y[g++] = z;
                        y[g++] = K;
                        break a
                    } while (z == x && K == C);
                    for (; b < q;) {
                        ...
                        b += t;
                        if (V != z || Z != K) {
                            var Ra = z - x, F = K - C, Ga = V - x, ra = Z - C;
    ...
    k.U = function () {
        var a = this.bb(), b = this.l, c = this.Ma(), d = this.Pa();
    ...
    k.$e = function (a, b, c) {
        ...
        var h = a.ka(), l = this.Pa(), d = Math.cos(-l), l = Math.sin(-l), m = Infinity, n = Infinity, p = -Infinity, q = -Infinity;
        a = a.sa();
        for (var t = 0, u = h.length; t < u; t += a)var y =
            h[t] * d - h[t + 1] * l, x = h[t] * l + h[t + 1] * d, m = Math.min(m, y), n = Math.min(n, x), p = Math.max(p, y), q = Math.max(q, x);
    ...
    k.sj = function (a, b, c) {
        var d = this.Pa(), e = Math.cos(-d), d = Math.sin(-d), f = a[0] * e - a[1] * d;
        a = a[1] * e + a[0] * d;
    ...
    function Od(a) {
        var b = a.rotation ? a.rotation : 0, c = a.start ? a.start : Date.now(), d = void 0 !== a.duration ? a.duration : 1E3, e = a.easing ? a.easing : Kd, f = a.anchor ? a.anchor : null;
        return function (a, h) {
    ...
    function ge(a, b) {
        var c = a.Tc(b[0]), d = a.Ga(b[0]), e = Wd(a.Va(b[0]), a.j);
        return [c[0] + (b[1] + .5) * e[0] * d, c[1] + (b[2] + .5) * e[1] * d]
    }

    k.Ia = function (a, b) {
        var c = this.Tc(a[0]), d = this.Ga(a[0]), e = Wd(this.Va(a[0]), this.j), f = c[0] + a[1] * e[0] * d, c = c[1] + a[2] * e[1] * d;
    ...
    function fe(a, b, c, d, e, f) {
        var g = a.wc(d), h = d / a.Ga(g), l = a.Tc(g);
        a = Wd(a.Va(g), a.j);
    ...
    k.Oo = function (a, b) {
        var c = this.yc();
        if (a < c) c = this.a[a], this.a[a] = b, this.b(new re(te, c)), this.b(new re(se, b)); else {
    ...
    var qe = "length", se = "add", te = "remove";
    ...
    v(re, Ka);
    var ue = /^#(?:[0-9a-f]{3}){1,2}$/i, ve = /^(?:rgb)?\((0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2})\)$/i, we = /^(?:rgba)?\((0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2}),\s?(0|[1-9]\d{0,2}),\s?(0|1|0\.\d{0,10})\)$/i, xe = /^([a-z]*)$/i;
    ...
    function Je(a) {
        if (a = a.frameState) {
            var b, c, d, e, f, g, h, l, m, n, p, q = a.layerStatesArray, t = ua({}, a.attributions), u = {}, y = a.viewState.projection;
            c = 0;
            for (b = q.length; c < b; c++)if (g = q[c].layer.ga())if (n = ea(g).toString(), m = g.j)for (d = 0, e = m.length; d < e; d++)if (h = m[d], l = ea(h).toString(), !(l in t)) {
                if (f = a.usedTiles[n]) {
                    var x = g.pb(y);
                    a:{
                        p = h;
                        ...
                        if (p.b) {
                            ...
                            for (Z in f)if (Z in p.b) {
                                ...
                                for (K = p.b[Z].length; z < K; ++z) {
                                    ...
                                    var F = be(x, ie(C), parseInt(Z, 10)), Ga =
                                        F.da - F.ba + 1;
                                    if (V.ba < F.ba || V.da > F.da)if (Td(Ra, new Qd(oa(V.ba, Ga), oa(V.da, Ga), V.ea, V.ha)) || V.da - V.ba + 1 > Ga && Td(Ra, F)) {
                                        p = !0;
                                        break a
                                    }
                                }
    ...
    function Qe(a) {
        ...
        He.call(this, {element: d, render: b, target: a.target});
    ...
    v(Df, Ka);
    function Gf(a) {
        if (a.buttons || If) a = a.buttons; else switch (a.which) {
            case 1:
                a = 1;
                break;
            case 2:
    ...
    var Sf = [["bubbles", !1], ["cancelable", !1], ["view", null], ["detail", null], ["screenX", 0], ["screenY", 0], ["clientX", 0], ["clientY", 0], ["ctrlKey", !1], ["altKey", !1], ["shiftKey", !1], ["metaKey", !1], ["button", 0], ["relatedTarget", null], ["buttons", 0], ["pointerId", 0], ["width", 0], ["height", 0], ["pressure", 0], ["tiltX", 0], ["tiltY", 0], ["pointerType", ""], ["hwTimestamp", 0], ["isPrimary", !1], ["type", ""], ["target", null], ["currentTarget", null], ["which", 0]];
    ...
    var Zf = "singleclick", Xf = "click", Yf = "dblclick", eg = "pointerdrag", dg = "pointermove", cg = "pointerdown", ag = "pointerup", bg = "pointercancel", fg = {
        xp: Zf,
        mp: Xf,
        np: Yf,
        qp: eg,
    ...
    function Tg(a) {
        ...
        var b = a.$();
        Hd(b, -1);
        var c = b.Pa(), d = this.j, c = b.constrainRotation(c, 0);
        vg(a, b, c, void 0, d);
        return !1
    }
    ...
    fh.prototype.o = function () {
        ...
        if (this.G) {
            var e = b.Jc(c), d = [a.Ca(Sb(d)), a.Ca(Vb(d))], f = Kb(Infinity, Infinity, -Infinity, -Infinity, void 0), g, h;
            g = 0;
        ...
        e = b.Ma();
        f = b.bb();
        a.ab(Pd({resolution: e, duration: this.j, easing: Jd}));
        a.ab(Nd({source: f, duration: this.j, easing: Jd}));
        b.rb(ac(d));
        b.Yb(c)
    };
    function gh(a) {
        tg.call(this, {handleEvent: hh});
        a = a || {};
        this.a = function (a) {
            return Eg(a) && Gg(a)
        };
    ...
    function mh(a) {
        Jg.call(this, {handleDownEvent: nh, handleDragEvent: oh, handleUpEvent: ph});
        a = a || {};
        this.i = null;
        this.j = void 0;
        this.a = !1;
    ...
    function ph(a) {
        if (2 > this.l.length) {
            ...
            Hd(b, -1);
            if (this.a) {
                var c = b.Pa(), d = this.i, e = this.u, c = b.constrainRotation(c, 0);
                vg(a, b, c, d, e)
            }
            return !1
        }
    ...
    mh.prototype.Fc = hc;
    function qh(a) {
        Jg.call(this, {handleDownEvent: rh, handleDragEvent: sh, handleUpEvent: th});
        a = a ? a : {};
        this.i = null;
    ...
    function sh(a) {
        ...
        1 != b && (this.j = b);
        a = a.map;
        var e = a.$(), c = e.Ma(), d = a.a.getBoundingClientRect(), f = Lg(this.l);
        f[0] -= d.left;
        f[1] -= d.top;
        this.i = a.Ja(f);
        a.render();
    ...
    function uh(a) {
        a = a ? a : {};
        var b = new me, c = new rg(-.005, .05, 100);
        ...
        (void 0 !== a.pinchZoom ? a.pinchZoom : 1) && b.push(new qh({duration: a.zoomDuration}));
    ...
    function zh(a) {
        lc.call(this, {code: a, units: "m", extent: Ah, global: !0, worldExtent: Bh})
    }
    ...
    var Ch = 6378137 * Math.PI, Ah = [-Ch, -Ch, Ch, Ch], Bh = [-180, -85, 180, 85], zc = "EPSG:3857 EPSG:102100 EPSG:102113 EPSG:900913 urn:ogc:def:crs:EPSG:6.18:3:3857 urn:ogc:def:crs:EPSG::3857 http://www.opengis.net/gml/srs/epsg.xml#3857".split(" ").map(function (a) {
        return new zh(a)
    });
    ...
    function Rh(a, b) {
        var c = a[0], d = a[1], e = a[2], f = a[3], g = a[4], h = a[5], l = b[0], m = b[1], n = b[2], p = b[3], q = b[4], t = b[5];
        a[0] = c * l + e * m;
        a[1] = d * l + f * m;
        a[2] = c * n + e * p;
        a[3] = d * n + f * p;
    ...
    k.xa = function (a, b, c, d, e, f) {
        function g(a, e) {
            var f = ea(a).toString(), g = b.layerStates[ea(e)].sd;
    ...
    function ti(a, b) {
        ...
        var g = 2 * (a.a + f) + 1, d = {strokeStyle: e, Dd: f, size: g, lineDash: d};
        if (void 0 === b) e = De(g, g), a.f = e.canvas, c = g = a.f.width, a.wh(d, e, 0, 0), a.C = [d.size, d.size], a.g ? a.j = a.f : (e = De(d.size, d.size), a.j = e.canvas, a.vh(d, e, 0, 0)); else {
            g = Math.round(g);
            (e = !a.g) && (c = a.vh.bind(a, d));
            var f = a.b ? ui(a.b) : "-", h = a.g ? vi(a.g) : "-";
    ...
    function Ci() {
        if (!Bi) {
            var a = new wi({color: "rgba(255,255,255,0.4)"}), b = new xi({color: "#3399CC", width: 1.25});
            Bi = [new yi({image: new si({fill: a, stroke: b, radius: 5}), fill: a, stroke: b})]
        }
        return Bi
    }
    ...
    function Di() {
        ...
        a.Polygon = [new yi({fill: new wi({color: [255, 255, 255, .5]})})];
        a.MultiPolygon = a.Polygon;
        a.LineString = [new yi({stroke: new xi({color: b, width: 5})}), new yi({stroke: new xi({color: c, width: 3})})];
        a.MultiLineString = a.LineString;
        a.Circle = a.Polygon.concat(a.LineString);
        a.Point = [new yi({
            image: new si({radius: 6, fill: new wi({color: c}), stroke: new xi({color: b, width: 1.5})}),
            zIndex: Infinity
        })];
    ...
    k.Ye = function (a) {
        if (dc(this.c, a.D())) {
            if (this.b || this.a) {
                this.a && Ni(this, this.a);
                this.b && Oi(this, this.b);
                var b = this.f, c = Ti(a), d = 0, e = a.c, f = a.sa(), g, h;
                b.beginPath();
                g = 0;
    ...
    k.Zb = function (a) {
        if (a) {
            ...
            var b = a.g, d = a.c, e = a.i, f = a.s, g = a.j, c = a.a, h = a.Fa(), l = a.l;
            a = a.o;
            this.P = {
        ...
        for (var n = 0, p = g.length, q, t, u = a.fa, y = a.$a, x, C, z, K, V = 0, Z = 0, Ra = a.a != g || a.overlaps ? 0 : 200; n < p;) {
            ...
            switch (F[0]) {
                ...
                case 4:
                    ...
                    ra = F[4] * c;
                    Oa = F[5] * c;
                    var Nb = F[6], Ub = F[7], oc = F[8], Gc = F[9];
                    Sa = F[10];
                    z = F[11];
                    K = F[12];
                    var pc = F[13], oe = F[14];
                    for (Sa && (z += e); q < t; q += 2) {
                        ...
                        if (1 != K || 0 !== z) {
                            var pe = F + ra, bd = Sa + Oa;
                            Xh(u, pe, bd, K, K, z, -pe, -bd);
                            b.setTransform.apply(b, u)
                        }
                        pe = b.globalAlpha;
                        1 != Ub && (b.globalAlpha = pe * Ub);
                        var bd = oe + oc > Ga.width ? Ga.width - oc : oe, Rn = Nb + Gc > Ga.height ?
                        Ga.height - Gc : Nb;
                ...
                case 8:
                    ...
                    for (q += 2; q < t; q += 2)if (F = m[q], Sa = m[q + 1], z = F + .5 | 0, K = Sa + .5 | 0, q == t - 2 || z !== x || K !== C) b.lineTo(F, Sa), x = z, C = K;
                    ++n;
                    break;
                case 9:
                    a.P = F[2];
    ...
    qj.prototype.rc = function (a, b) {
        if (this.j) {
            lj(this, b);
            var c = a.ka(), d = this.coordinates.length, c = kj(this, c, 0, c.length, a.sa(), !1, !1);
    ...
    k.Ye = function (a, b) {
        ...
        if (void 0 !== c.fillStyle || void 0 !== d) {
            ...
            this.b.push([9, Ae(ni)]);
            void 0 !== c.strokeStyle && this.b.push([10, c.strokeStyle, c.lineWidth, c.lineCap, c.lineJoin, c.miterLimit, c.lineDash]);
            var c = a.c, d = Ti(a), e = a.sa(), f = 0, g, h;
            g = 0;
    ...
    xj.prototype.Zb = function (a) {
        if (a) {
            ...
            var c = a.f;
            if (c) {
                var b = c.a, d = c.c, e = c.g, f = c.i, g = c.f, c = c.j, d = void 0 !== d ? d : "round", e = e ? e.slice() : oi, f = void 0 !== f ? f : "round", g = void 0 !== g ? g : 1, c = void 0 !== c ? c : 10, b = Ce(b ? b : pi);
                if (this.c) {
                    var h = this.c;
                    h.lineCap = d;
                    h.lineDash = e;
            ...
            var l = a.g, b = a.c, d = a.i, e = a.s, g = a.j, c = a.a, f = a.Fa(), h = a.l, m = a.o;
    ...
    Aj.prototype.xa = function (a, b, c, d, e) {
        var f = Xh(this.j, .5, .5, 1 / b, -1 / b, -c, -a[0], -a[1]), g = this.i;
        g.clearRect(0, 0, 1, 1);
        var h;
    ...
    function Cj(a, b, c, d, e, f, g) {
        ...
        var l, m, n, p, q;
        l = 0;
        for (m = h.length; l < m; ++l)for (p = a.a[h[l].toString()], n = zj.length - 1; 0 <= n; --n)if (q = p[zj[n]], void 0 !== q && (q = nj(q, b, 1, c, d, e, q.b, f, g)))return q
    }

    var Dj = {Image: qj, LineString: rj, Polygon: uj, Text: xj};
    ...
    var Jj, Kj = -1 < navigator.userAgent.indexOf("OPR"), Lj = -1 < navigator.userAgent.indexOf("Edge");
    ...
    function Oj(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        var t = De(Math.round(c * Zb(q) / d), Math.round(c * $b(q) / d)), u = c / d;
        l.forEach(function (a) {
        ...
        h.f.forEach(function (a) {
            ...
            a = (e[0][0] -
                y[0]) / f;
            var n = -(e[0][1] - y[1]) / f, u = (e[1][0] - y[0]) / f, ra = -(e[1][1] - y[1]) / f, Oa = (e[2][0] - y[0]) / f, Sa = -(e[2][1] - y[1]) / f, e = b[0][0], b = b[0][1], g = g - e, h = h - b, l = l - e, m = m - b;
            a:{
                g = [[g, h, 0, 0, u - a], [l, m, 0, 0, Oa - a], [0, 0, g, h, ra - n], [0, 0, l, m, Sa - n]];
                h = g.length;
                for (l = 0; l < h; l++) {
                    ...
                    g[m] = g[l];
                    g[l] = Nb;
                    for (m = l + 1; m < h; m++)for (Nb = -g[m][l] / g[l][l], Ub = l; Ub < h + 1; Ub++)g[m][Ub] = l == Ub ? 0 : g[m][Ub] + Nb * g[l][Ub]
                }
                l = Array(h);
                for (m = h - 1; 0 <= m; m--)for (l[m] = g[m][h] / g[m][m], Nb = m - 1; 0 <= Nb; Nb--)g[Nb][h] -= g[Nb][m] * l[m];
                g = l
            }
    ...
    function Qj(a, b, c, d, e, f, g, h, l, m) {
        var n = Ab([f, g, h, l]), p = a.b ? Zb(n) / a.b : null, q = a.b, t = a.g.a && .5 < p && 1 > p, u = !1;
        if (0 < m) {
            if (a.c.g && a.j)var y = Ab([b, c, d, e]), u = u | .25 < Zb(y) / a.j;
            !t && a.g.g && p && (u |= .25 < p)
        }
        if (u || !a.i || dc(n, a.i)) {
    ...
    v(Tj, Ua);
    function Uj(a) {
        if ("string" === typeof a)return [new le({html: a})];
        if (a instanceof le)return [a];
        if (Array.isArray(a)) {
            for (var b = a.length, c = Array(b), d = 0; d < b; d++) {
                var e = a[d];
                c[d] = "string" === typeof e ? new le({html: e}) : e
            }
            return c
        }
        return null
    ...
    v(Yj, Ka);
    var Zj = "imageloadstart", ak = "imageloadend", bk = "imageloaderror";
    ...
    gk.prototype.Bc = function (a, b, c, d) {
        if (this.f && this.f.a())if (this.a.ga() instanceof ek) {
    ...
    gk.prototype.j = function (a, b) {
        ...
        if (this.f) {
            var d = this.f, h = d.D(), l = d.resolution, m = d.f, f = c * l / (f * m), n = Ph(this.s);
    ...
    hk.prototype.j = function (a, b) {
        ...
        var d = a.pixelRatio, e = a.viewState, f = e.projection, g = this.a, h = g.ga(), l = h.pb(f), e = l.wc(e.resolution, this.B), m = l.Ga(e), n = a.extent;
        void 0 !== b.extent && (n = cc(n, b.extent));
        if (Yb(n))return !1;
        var m = ee(l, n, m), p = {};
        p[e] = {};
        var q = this.Ue(h, f, p), t = g.c(), u = this.o, y = new Qd(0, 0, 0, 0), x, C, z, K;
        for (z = m.ba; z <= m.da; ++z)for (K = m.ea; K <= m.ha; ++K)x = h.vc(e, z, K, d, f), c(x) || (x = ig(x)), c(x) ? p[e][x.ya.toString()] = x : (C = ce(l, x.ya, q, y, u), C || (x = de(l, x.ya, y,
            u)) && q(e + 1, x));
        ...
        u.length = 0;
        var V, y = 0;
        for (z = q.length; y < z; ++y)for (V in x = q[y], K = p[x], K)x = K[V], x.U() == jg && u.push(x);
    ...
    function ik(a, b, c, d) {
        var e = a.l;
        if (0 !== e.length) {
            var f = c.pixelRatio, g = c.viewState, h = g.center, l = g.projection, m = g.rotation, n = c.size, p = Math.round(f * n[0] / 2), n = Math.round(f * n[1] / 2), g = f / g.resolution, q = a.a, t = q.ga(), u = t.gb(f) * t.df(l), y = t.pb(l), q = Na(q, "render"), x = b, C = 1, z, K, V;
            if (m || q) {
                x = a.c;
                z = x.canvas;
                var C = t.gb(f) / f, Z = b.canvas.width * C;
                K = b.canvas.height * C;
            ...
            var Ga = d.extent;
            if (d = void 0 !== Ga) {
                var ra = Wb(Ga), Oa = Vb(Ga), Sa = Tb(Ga), Ga = Sb(Ga);
                ...
                var Nb = z || 0, Ub = K || 0;
                x.save();
                var oc = x.canvas.width / 2, Gc = x.canvas.height / 2;
                qi(x, -m, oc, Gc);
                x.beginPath();
            ...
            for (Oa = e.length; ra < Oa; ++ra) {
                var Sa = e[ra], Ga = Sa.ya, Gc = y.Ia(Ga, a.o), oc = Ga[0], pc = Sb(y.Ia(y.Zd(h, oc, a.P))), Ga = Math.round(Zb(Gc) * g), Nb = Math.round($b(Gc) * g), Ub = Math.round((Gc[0] - pc[0]) * g / Ga) * Ga + p + Math.round((pc[0] - h[0]) * g), Gc = Math.round((pc[1] - Gc[3]) * g / Nb) * Nb + n + Math.round((h[1] - pc[1]) * g);
                if (!F) {
    ...
    jk.prototype.i = function (a, b, c) {
        var d = a.extent, e = a.pixelRatio, f = b.sd ? a.skippedFeatureUids : {}, g = a.viewState, h = g.projection, g = g.rotation, l = h.D(), m = this.a.ga(), n = hj(this, a, 0);
        ...
        if ((p = this.l) && !p.g()) {
            ...
            if (Na(this.a, "render")) {
                ...
                if (g) {
                    var C = Math.round(Math.sqrt(y * y + x * x)), t = (C - y) / 2, u = (C - x) / 2;
                    y = x = C
                }
    ...
    jk.prototype.j = function (a) {
        function b(a) {
            ...
            if (b) {
                if (b) {
                    d = !1;
                    if (Array.isArray(b))for (var e = 0, f = b.length; e < f; ++e)d = Gj(q, a, b[e], Fj(m, n), this.G, this) || d; else d = Gj(q, a, b, Fj(m, n), this.G, this) || d;
                    a = d
                } else a = !1;
                this.c = this.c || a
            }
    ...
    v(kk, hk);
    var lk = {image: zj, hybrid: ["Polygon", "LineString"]}, mk = {hybrid: ["Image", "Text"], vector: zj};
    kk.prototype.i = function (a, b, c) {
        ...
        e !== Gi && ik(this, c, a, b);
        if (e !== Ei) {
            var g = this.a, e = mk[g.u], h = a.pixelRatio, l = b.sd ? a.skippedFeatureUids : {}, m = a.viewState, n = m.center, p = m.rotation, q = a.size, m = h / m.resolution, t = g.ga(), u = t.gb(), y = hj(this, a, 0);
    ...
    function nk(a, b, c) {
        function d(a) {
            ...
            if (b) {
                ...
                if (b) {
                    var f = !1;
                    if (Array.isArray(b))for (var g = 0, h = b.length; g < h; ++g)f = Gj(d, a, b[g], c, this.C, this) || f; else f = Gj(d, a, b, c, this.C, this) || f;
                    a = f
                } else a = !1;
                this.u = this.u || a;
                l.jd = l.jd || a
        ...
        if (l.jd || l.Rh != g || l.Qf != h) {
            l.Ad = null;
            l.jd = !1;
            var m = e.ga(), n = m.tileGrid, p = b.ya, q = b.l, t = "tile-pixels" ==
                q.yb(), u = n.Ga(p[0]), y;
            if (t)var x = t = m.gb(), n = Wd(n.Va(p[0])), n = [0, 0, n[0] * x, n[1] * x]; else t = u, n = n.Ia(p), Hc(c, q) || (y = !0, b.uf(c));
            l.jd = !1;
            var C = new Aj(0, n, t, m.i, e.i), z = Fj(t, f);
            b = b.c;
            h && h !== l.Qf && b.sort(h);
            m = 0;
    ...
    kk.prototype.xa = function (a, b, c, d) {
        ...
        var f = this.a, g = {}, h = this.l, l = f.ga(), m = l.tileGrid, n, p, q, t, u, y;
        q = 0;
    ...
    kk.prototype.j = function (a, b) {
        ...
        if (c)for (var d = Object.keys(a.Ce || {}), e = 0, f = this.l.length; e < f; ++e) {
            var g = this.l[e];
            nk(this, g, a);
            var h = g, g = a, l = this.a, m = lk[l.u];
            if (m) {
                var n = g.pixelRatio, p = h.f, q = l.g;
                if (!eb(p.li, d) || p.Rf !== q) {
                    p.li = d;
                    p.Rf = q;
                    var q = h.g, t = l.ga(), u = t.tileGrid, y = h.ya[0], x = u.Ga(y), l = Wd(u.Va(y)), y = u.Ga(y), C = y / x, z = l[0] * n * C, K = l[1] * n * C;
    ...
    function Fk(a) {
        if (!a.i) {
            ...
            var d = Gk(b, 1, 1), e = b.createRenderbuffer();
    ...
    function Nk(a, b, c, d) {
        var e = a.C, f = a.B, g = a.S, h = a.na, l = a.za, m = a.P, n = a.W, p = a.Qa, q = a.Z ? 1 : 0, t = a.$a, u = a.fa, y = a.Ib, x = Math.cos(t), t = Math.sin(t), C = a.a.length, z = a.b.length, K, V, Z, Ra, F, Ga;
    ...
    Lk.prototype.Za = function (a, b, c, d, e, f, g, h, l, m, n) {
        ...
        f.uniform1f(q.i, g);
        var t;
        if (void 0 === l) Qk(this, f, a, h, this.oa, this.u); else {
            if (m)a:{
                d = a.g ? 5125 : 5123;
                a = a.g ? 4 : 2;
                e = this.g.length - 1;
    ...
    function Vk(a, b, c, d, e, f, g, h, l, m, n) {
        var p = Wk, q, t;
        for (q = zj.length - 1; 0 <= q; --q)if (t = a.a[zj[q]], void 0 !== t && (t = t.Za(b, c, d, e, p, f, g, h, l, m, n)))return t
    }
    ...
    k.rc = function (a, b) {
        var c = this.b, d = (new Rk(1, this.g)).b(0, "Image");
        d.Xb(this.a);
        d.rc(a, b);
        Ok(d, c);
    ...
    gl.prototype.yf = function (a, b) {
        ...
        l && (c = this.f.c.j, il(this, c.width, c.height, d, f, g, h, l.D()), this.o = null, d = this.s, Ph(d), Vh(d, 1, -1), Wh(d, 0,
            -1), this.c = l, this.tb = m, $i(a.attributions, l.j), aj(a, n));
        return !0
    };
    ...
    gl.prototype.Bc = function (a, b, c, d) {
        if (this.c && this.c.a())if (this.a.ga() instanceof ek) {
    ...
    k.yf = function (a, b, c) {
        var d = this.f, e = c.b, f = a.viewState, g = f.projection, h = this.a, l = h.ga(), m = l.pb(g), n = m.wc(f.resolution), p = m.Ga(n), q = l.kf(n, a.pixelRatio, g), t = q[0] / Wd(m.Va(n), this.P)[0], u = p / t, y = l.gb(t) * l.df(g), x = f.center, C = a.extent, z = ee(m, C, p);
        if (this.l && Sd(this.l, z) && this.o == l.g) u = this.C; else {
            var K = [z.da - z.ba + 1, z.ha - z.ea + 1], V = ka(Math.max(K[0] * q[0], K[1] * q[1])), K = u * V, Z = m.Tc(n), Ra = Z[0] + z.ba * q[0] * u, u = Z[1] + z.ea * q[1] * u, u = [Ra, u, Ra + K, u + K];
            el(this, a, V);
            e.viewport(0, 0, V, V);
            ...
            c = {};
            c[n] = {};
            var F = this.Ue(l, g, c), Ga = h.c(), V = !0, Ra = Bb(), ra = new Qd(0, 0, 0, 0), Oa, Sa, Nb;
            for (Sa = z.ba; Sa <= z.da; ++Sa)for (Nb = z.ea; Nb <= z.ha; ++Nb) {
                Z = l.vc(n, Sa, Nb, t, g);
            ...
            b.sort(Ya);
            for (var F = new Float32Array(4), Ub, Ga = 0, ra = b.length; Ga < ra; ++Ga)for (Ub in Sa = c[b[Ga]], Sa)Z = Sa[Ub], Oa = m.Ia(Z.ya, Ra), F[0] = 2 * (Oa[2] - Oa[0]) / K, F[1] = 2 * (Oa[3] - Oa[1]) / K, F[2] = 2 * (Oa[0] - u[0]) / K - 1, F[3] = 2 * (Oa[1] - u[1]) / K - 1, e.uniform4fv(this.c.f,
    ...
    k.yf = function (a, b, c) {
        function d(a) {
            ...
            if (b) {
                if (b) {
                    c = !1;
                    if (Array.isArray(b))for (var d = 0, f = b.length; d < f; ++d)c = Gj(q, a, b[d], Fj(m, n), this.mh, this) || c; else c = Gj(q, a, b, Fj(m, n), this.mh, this) || c;
                    a = c
                } else a = !1;
                this.o = this.o || a
            }
    ...
    k.Jo = function (a) {
        ...
        if (void 0 !== e && 0 < e[0] && 0 < e[1] && f && Gd(f)) {
            var h = Cd(f, this.f ? this.f.viewHints : void 0), l = this.tc().ff(), m = {};
            b = 0;
    ...
    function xl(a) {
        ...
        e = a.layers instanceof xh ? a.layers : new xh({layers: a.layers});
        c[yl] = e;
        c[Bl] = a.target;
    ...
    var yl = "layergroup", Al = "size", Bl = "target", zl = "view";
    Hh();
    function Cl(a) {
        Ua.call(this);
        this.j = a.id;
    ...
    k.Nk = function () {
        ...
        if (void 0 !== this.get(Gl) && this.autoPan) {
            var a = this.he();
            if (void 0 !== a && a.uc()) {
                var b = Kl(a.uc(), a.kb()), c = this.Td(), d = c.offsetWidth, e = c.currentStyle || getComputedStyle(c), d = d + (parseInt(e.marginLeft, 10) + parseInt(e.marginRight, 10)), e = c.offsetHeight, f = c.currentStyle || getComputedStyle(c), e = e + (parseInt(f.marginTop, 10) + parseInt(f.marginBottom, 10)), g = Kl(c, [d, e]), c = this.l;
    ...
    function Jl(a) {
        ...
        if (void 0 !== b && b.f && void 0 !== c) {
            var c = b.Ca(c), d = b.kb(), b = a.f.style, e = a.Eg(), f = a.Fg(), g = e[0], e = e[1];
            if (f == Ml || f == Nl || f == Ol) "" !== a.a.fe && (a.a.fe = b.left = ""), g = Math.round(d[0] - c[0] - g) + "px", a.a.Be != g && (a.a.Be = b.right = g); else {
    ...
    var Sl = "bottom-left", Pl = "bottom-center", Ml = "bottom-right", Tl = "center-left", Ql = "center-center", Nl = "center-right", Il = "top-left", Rl = "top-center", Ol = "top-right", Dl = "element", El = "map", Fl = "offset", Gl = "position", Hl = "positioning";
    ...
    function Ul(a) {
        ...
        var f = this.f = new H({controls: new me, interactions: new me, target: c, view: a.view});
        ...
        this.C = new Cl({position: [0, 0], positioning: Sl, element: e});
        this.f.hg(this.C);
        e = document.createElement("div");
        e.className = b + " ol-unselectable ol-control" + (this.j && this.l ? " ol-collapsed" : "") + (this.l ? "" : " ol-uncollapsible");
        e.appendChild(c);
        e.appendChild(d);
        He.call(this, {element: e, render: a.render ? a.render : Vl, target: a.target})
    }
    ...
    function Vl() {
        ...
        if (a.f && b.f) {
            var c = a.kb(), a = a.$().Jc(c), d = b.kb(), c = b.$().Jc(d), e = b.Ca(Wb(a)), f = b.Ca(Tb(a)), b = Math.abs(e[0] - f[0]), e = Math.abs(e[1] - f[1]), f = d[0], d = d[1];
    ...
    function Xl(a) {
        var b = a.a, c = a.f;
        if (b.f && c.f) {
            var d = b.kb(), e = b.$(), f = c.$(), c = e.Pa(), b = a.C, g = a.C.Td(), h = e.Jc(d), d = f.Ma(), e = Sb(h), f = Vb(h), l;
    ...
    function Zl(a) {
        ...
        this.B = void 0;
        this.C = "";
        He.call(this, {element: this.f, render: a.render ? a.render : $l, target: a.target});
    ...
    var am = "units", em = "degrees", fm = "imperial", gm = "nautical", bm = "metric", hm = "us";
    ...
    function im(a) {
        ...
        w(c, "click", La);
        He.call(this, {element: d, render: a.render ? a.render : km})
    }
    ...
    k.vk = function (a) {
        ...
        b.ab(Pd({resolution: d, duration: this.Z, easing: Jd}));
    ...
    k.Ig = function () {
        if (this.C) {
            var a = this.a, b = a.$();
            Hd(b, -1);
            a.ab(Pd({resolution: this.f, duration: this.Z, easing: Jd}));
    ...
    var qm = "alpha", sm = "beta", tm = "gamma", rm = "heading", pm = "tracking";
    ...
    k.vb = function (a, b, c, d) {
        ...
        if (this.G != this.g) {
            ...
            h = 0;
            for (l = e.length; h < l; ++h)var m = e[h], g = Wc(this.A, f, m, this.a, g), f = m[m.length - 1];
            this.S = Math.sqrt(g);
            this.G = this.g
        }
        e = Ti(this);
    ...
    k.dm = function () {
        var a = Ti(this), b = this.c, c = 0, d = 0, e, f;
        e = 0;
        for (f = b.length; e < f; ++e)var g = b[e], d = d + Tc(a, c, g, this.a), c = g[g.length - 1];
        return d
    };
    k.Y = function (a) {
        var b;
    ...
    function Ti(a) {
        if (a.P != a.g) {
            ...
            a:{
                ...
                var d, e;
                d = 0;
                for (e = c.length; d < e; ++d)if (!qd(b, c[d], a.a, void 0)) {
                    c = !1;
                    break a
                }
                c = !0
    ...
    k.Mc = function (a) {
        ...
        l = 0;
        for (m = e.length; l < m; ++l) {
            var n = e[l], p = [], h = fd(d, g, n, f, a, b, h, p);
            c.push(p);
            g = n[n.length - 1]
        }
        b.length = h;
    ...
    k.Na = function (a) {
        a:{
            var b = Ti(this), c = this.c, d = this.a, e = 0, f, g;
            f = 0;
            for (g = c.length; f < g; ++f) {
                var h = c[f];
                if (od(b, e, h, d, a)) {
    ...
    function cn(a, b) {
        ...
        if ("number" === typeof a.x && "number" === typeof a.y) c = "Point"; else if (a.points) c = "MultiPoint"; else if (a.paths) c = 1 === a.paths.length ? "LineString" : "MultiLineString"; else if (a.rings) {
            ...
            for (; c.length;) {
                d = c.shift();
                e = !1;
                for (g = f.length - 1; 0 <= g; g--)if (Ib((new gd(f[g][0])).D(), (new gd(d)).D())) {
                    f[g].push(d);
                    e = !0;
                    break
                }
    ...
    k.Na = function (a) {
        var b = this.f, c, d;
        c = 0;
        for (d = b.length; c < d; ++c)if (b[c].Na(a))return !0;
        return !1
    };
    k.rotate = function (a, b) {
    ...
    k.ze = function (a, b) {
        ...
        if (c && c[0]) {
            var d = new B(null), e = c[0], f = [e.length], g, h;
            g = 1;
    ...
    k.Ji = {"http://www.opengis.net/gml": {pointMember: Dm(Tn.prototype.Dh), pointMembers: Dm(Tn.prototype.Dh)}};
    k.Ii = {
    ...
    k.Ki = {"http://www.opengis.net/gml": {polygonMember: Dm(Tn.prototype.Eh), polygonMembers: Dm(Tn.prototype.Eh)}};
    k.Ni = {"http://www.opengis.net/gml": {Point: Dm(Tn.prototype.we)}};
    k.Gi = {"http://www.opengis.net/gml": {LineString: Dm(Tn.prototype.ye)}};
    k.Oi = {"http://www.opengis.net/gml": {Polygon: Dm(Tn.prototype.ze)}};
    k.Id = {"http://www.opengis.net/gml": {LinearRing: Em(Tn.prototype.oo)}};
    k.kc = function (a, b) {
    ...
    k.Jf = function (a, b) {
        var c = xm(a, !1).replace(/^\s*|\s*$/g, ""), d = b[0].srsName, e = a.parentNode.getAttribute("srsDimension"), f = "enu";
        d && (f = qc(d).b);
        c = c.split(/\s+/);
        d = 2;
    ...
    k.Hd = {"http://www.opengis.net/gml": {pos: Em(go.prototype.po), posList: Em(go.prototype.Jf)}};
    k.Ke = {"http://www.opengis.net/gml": {interior: go.prototype.al, exterior: go.prototype.vj}};
    k.Yf = {
        "http://www.opengis.net/gml": {
    ...
    k.Hi = {"http://www.opengis.net/gml": {curveMember: Dm(go.prototype.pg), curveMembers: Dm(go.prototype.pg)}};
    k.Li = {"http://www.opengis.net/gml": {surfaceMember: Dm(go.prototype.ni), surfaceMembers: Dm(go.prototype.ni)}};
    k.Di = {"http://www.opengis.net/gml": {LineString: Dm(Tn.prototype.ye), Curve: Dm(go.prototype.Fh)}};
    k.Si = {"http://www.opengis.net/gml": {Polygon: Dm(Tn.prototype.ze), Surface: Dm(go.prototype.Ph)}};
    k.Ti = {"http://www.opengis.net/gml": {patches: Em(go.prototype.wo)}};
    k.Ei = {"http://www.opengis.net/gml": {segments: Em(go.prototype.yo)}};
    k.Fi = {"http://www.opengis.net/gml": {lowerCorner: Dm(go.prototype.Jf), upperCorner: Dm(go.prototype.Jf)}};
    k.Mi = {"http://www.opengis.net/gml": {PolygonPatch: Em(go.prototype.xo)}};
    k.Ri = {"http://www.opengis.net/gml": {LineStringSegment: Em(go.prototype.ro)}};
    function ho(a, b, c) {
    ...
    var io = {"http://www.opengis.net/gml": {lowerCorner: L(co), upperCorner: L(co)}};
    k = go.prototype;
    k.jp = function (a, b, c) {
        var d = c[c.length - 1].srsName;
        d && a.setAttribute("srsName", d);
        Mm({node: a}, io, Jm, [b[0] + " " + b[1], b[2] + " " + b[3]], c, ["lowerCorner", "upperCorner"], this)
    };
    k.wi = function (a, b, c) {
        var d = c[c.length - 1].srsName;
        d && a.setAttribute("srsName", d);
    ...
    k.yi = function (a, b, c) {
        ...
        b = b.Wd();
        Mm({node: a, srsName: e, surface: d}, ko, this.c, b, c, void 0, this)
    };
    k.kp = function (a, b, c) {
        var d = c[c.length - 1].srsName;
        d && a.setAttribute("srsName", d);
        b = b.je();
        Mm({node: a, srsName: d}, lo, Hm("pointMember"), b, c, void 0, this)
    };
    k.xi = function (a, b, c) {
        var d = c[c.length - 1], e = d.srsName, d = d.curve;
        e && a.setAttribute("srsName", e);
        b = b.od();
        Mm({node: a, srsName: e, curve: d}, mo, this.c, b, c, void 0, this)
    };
    k.Ai = function (a, b, c) {
    ...
    }, lo = {"http://www.opengis.net/gml": {pointMember: L(go.prototype.lp)}}, mo = {
        "http://www.opengis.net/gml": {
            lineStringMember: L(go.prototype.vi),
            curveMember: L(go.prototype.vi)
        }
    }, jo = {"http://www.opengis.net/gml": {exterior: L(go.prototype.Ai), interior: L(go.prototype.Ai)}}, no = {
        "http://www.opengis.net/gml": {
    ...
    go.prototype.T = function (a, b) {
        b = Sm(this, b);
        var c = wm("http://www.opengis.net/gml", "geom"), d = {
            node: c,
    ...
    k.Hd = {"http://www.opengis.net/gml": {coordinates: Em(po.prototype.Hh)}};
    k.Ke = {"http://www.opengis.net/gml": {innerBoundaryIs: po.prototype.Zk, outerBoundaryIs: po.prototype.Tn}};
    k.Ci = {"http://www.opengis.net/gml": {coordinates: Dm(po.prototype.Hh)}};
    k.Yf = {
        "http://www.opengis.net/gml": {
            Point: Em(Tn.prototype.Nh),
            MultiPoint: Em(Tn.prototype.Lh),
    ...
    function wo(a, b) {
        var c = b[0], d = N({flatCoordinates: []}, xo, a, b);
        if (d) {
    ...
    function yo(a, b) {
        var c = b[0], d = N({flatCoordinates: [], ends: []}, zo, a, b);
        if (d) {
            var e = d.flatCoordinates;
            delete d.flatCoordinates;
            var f = d.ends;
    ...
    function Ao(a, b) {
        var c = b[0], d = N({}, Bo, a, b);
        if (d) {
            var e = so([], a, d), e = new A(e, "XYZM");
            Tm(e, !1, c);
            c = new I(e);
            c.H(d);
            return c
    ...
    var Co = {rte: wo, trk: yo, wpt: Ao}, Do = M(ro, {
            rte: Dm(wo),
            trk: Dm(yo),
            wpt: Dm(Ao)
        }), uo = M(ro, {text: J(S, "linkText"), type: J(S, "linkType")}), xo = M(ro, {
            name: J(S),
            cmt: J(S),
            desc: J(S),
            src: J(S),
        ...
        }), Eo = M(ro, {ele: J(Yn), time: J(Xn)}), zo = M(ro, {
            name: J(S),
            cmt: J(S),
            desc: J(S),
            src: J(S),
        ...
        }), Go = M(ro, {ele: J(Yn), time: J(Xn)}), Bo = M(ro, {
            ele: J(Yn),
            time: J(Xn),
            magvar: J(Yn),
            geoidheight: J(Yn),
    ...
    function Io(a, b, c) {
        ...
        Mm({node: a}, Jo, Jm, [b.linkText, b.linkType], c, Ko)
    }
    ...
    function Lo(a, b, c) {
        ...
        d = Km(f, b);
        Mm({node: a, properties: f}, Oo, Jm, d, c, b)
    }

    var Ko = ["text", "type"], Jo = M(ro, {
            text: L(co),
            type: L(co)
        }), Po = M(ro, "name cmt desc src link number type rtept".split(" ")), Qo = M(ro, {
            name: L(co),
            cmt: L(co),
            desc: L(co),
            src: L(co),
            ...
            type: L(co),
            rtept: Gm(L(Lo))
        }), Mo = M(ro, ["ele", "time"]), Ro = M(ro, "name cmt desc src link number type trkseg".split(" ")), Uo = M(ro, {
            name: L(co),
            cmt: L(co),
            desc: L(co),
            src: L(co),
            ...
            trkseg: Gm(L(function (a, b, c) {
                Mm({node: a, geometryLayout: b.ia, properties: {}}, So, To, b.Y(), c)
            }))
        }), To = Hm("trkpt"),
        So = M(ro, {trkpt: L(Lo)}), No = M(ro, "ele time magvar geoidheight name cmt desc src link sym type fix sat hdop vdop pdop ageofdgpsdata dgpsid".split(" ")), Oo = M(ro, {
            ele: L(eo),
            time: L(function (a, b) {
            ...
            ageofdgpsdata: L(eo),
            dgpsid: L(fo)
        }), Vo = {Point: "wpt", LineString: "rte", MultiLineString: "trk"};
    ...
    v($o, Yo);
    var bp = /^B(\d{2})(\d{2})(\d{2})(\d{2})(\d{5})([NS])(\d{3})(\d{5})([EW])([AV])(\d{5})(\d{5})/, cp = /^H.([A-Z]{3}).*?:(.*)/, dp = /^HFDTE(\d{2})(\d{2})(\d{2})/, ep = /\r\n|\r|\n/;
    $o.prototype.wd = function (a, b) {
        var c = this.b, d = a.split(ep), e = {}, f = [], g = 2E3, h = 0, l = 1, m = -1, n, p;
        n = 0;
        for (p = d.length; n < p; ++n) {
            var q = d[n], t;
            if ("B" == q.charAt(0)) {
                if (t = bp.exec(q)) {
                    var q = parseInt(t[1], 10), u = parseInt(t[2], 10), y = parseInt(t[3], 10), x = parseInt(t[4], 10) + parseInt(t[5], 10) / 6E4;
                    "S" == t[6] && (x = -x);
    ...
    var gp = "barometric", fp = "gps", ap = "none";
    ...
    function jp(a) {
        ...
        var f = this.na, g = this.i, h = Mh.get(d, f, g);
    ...
    var lp = "fraction", op = "bottom-left", np = "bottom-right", kp = "top-left", mp = "top-right";
    ...
    function pp(a) {
        ...
        this.b = void 0 !== a.fill ? a.fill : new wi({color: "#333"});
    ...
    function qp(a) {
        ...
        this.defaultDataProjection = qc("EPSG:4326");
        var b;
        a.defaultStyle ? b = a.defaultStyle : (b = rp) || (sp = [255, 255, 255, 1], tp = new wi({color: sp}), up = [20, 2], vp = wp = "pixels", xp = [64, 64], yp = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", zp = .5, Ap = new jp({
            anchor: up,
            anchorOrigin: op,
            anchorXUnits: wp,
            anchorYUnits: vp,
            ...
            size: xp,
            src: yp
        }), Bp = "NO_IMAGE", Cp = new xi({color: sp, width: 1}), Dp = new xi({
            color: [51, 51, 51, 1],
            width: 2
        }), Ep = new pp({
            font: "bold 16px Helvetica",
            fill: tp, stroke: Dp, scale: .8
        }), Fp = new yi({fill: tp, image: Ap, text: Ep, stroke: Cp, zIndex: 0}), b = rp = [Fp]);
        this.g = b;
    ...
    v(qp, Pn);
    var Gp = ["http://www.google.com/kml/ext/2.2"], Hp = [null, "http://earth.google.com/kml/2.0", "http://earth.google.com/kml/2.1", "http://earth.google.com/kml/2.2", "http://www.opengis.net/kml/2.2"], Ip = {
        fraction: lp,
        pixels: "pixels"
    };
    ...
    function Up(a, b) {
        var c = N({}, Vp, a, b), d = N(null, Wp, a, b);
        if (d) {
            var e = new O(null);
            e.aa("XYZ", d);
            e.H(c);
    ...
    function Yp(a, b) {
        ...
        if (e)if ("Point" == f) {
            ...
            d.aa(e, f);
            $p(d, c)
        } else"LineString" == f ? (d = new P(null), Zm(d, c), $p(d, c)) : "Polygon" == f ? (d = new R(null), an(d, c), $p(d, c)) : "GeometryCollection" == f ? d = new Gn(c) : ha(!1, 37); else d = new Gn(c);
        return d
    }
    ...
    function bq(a, b) {
        var c = N({}, Vp, a, b), d = N([null], cq, a, b);
        if (d && d[0]) {
            var e = new B(null), f = d[0], g = [f.length], h, l;
            h = 1;
    ...
    function dq(a, b) {
        var c = N({}, eq, a, b);
        if (!c)return null;
        var d = "fillStyle" in c ? c.fillStyle : tp, e = c.fill;
        void 0 === e || e || (d = null);
        e = "imageStyle" in c ? c.imageStyle : Ap;
        e == Bp && (e = void 0);
        var f = "textStyle" in c ? c.textStyle : Ep, g = "strokeStyle" in c ? c.strokeStyle : Cp, c = c.outline;
        void 0 === c || c || (g = null);
        return [new yi({fill: d, image: e, stroke: g, text: f, zIndex: void 0})]
    }
    ...
    var hq = M(Hp, {value: Em(S)}), gq = M(Hp, {
        Data: function (a, b) {
        ...
        extrude: J(Vn),
        altitudeMode: J(S)
    }), Rp = M(Hp, {coordinates: Em(Np)}), cq = M(Hp, {
        ...
        when: function (a, b) {
            var c = b[b.length - 1].si, d = xm(a, !1), d = Date.parse(d);
            c.push(isNaN(d) ? 0 : d)
        }
    }, M(Gp, {
        coord: function (a, b) {
            var c = b[b.length - 1].A, d = xm(a, !1);
            (d = /^\s*([+\-]?\d+(?:\.\d*)?(?:e[+\-]?\d*)?)\s+([+\-]?\d+(?:\.\d*)?(?:e[+\-]?\d*)?)\s+([+\-]?\d+(?:\.\d*)?(?:e[+\-]?\d*)?)\s*$/i.exec(d)) ? c.push(parseFloat(d[1]), parseFloat(d[2]), parseFloat(d[3]), 0) : c.push(0, 0, 0, 0)
        }
    })), Wp = M(Hp, {coordinates: Em(Np)}), lq = M(Hp, {href: J(Op)}, M(Gp, {
        x: J(Yn),
        y: J(Yn),
        w: J(Yn),
        h: J(Yn)
        ...
        Icon: J(function (a, b) {
            var c = N({}, lq, a, b);
            return c ? c : null
        }), heading: J(Yn), hotSpot: J(function (a) {
            var b =
                a.getAttribute("xunits"), c = a.getAttribute("yunits");
            return {x: parseFloat(a.getAttribute("x")), Wf: Ip[b], y: parseFloat(a.getAttribute("y")), Xf: Ip[c]}
        }), scale: J(Pp)
    }), jq = M(Hp, {LinearRing: Em(Qp)}), nq = M(Hp, {color: J(Mp), scale: J(Pp)}), oq = M(Hp, {
        color: J(Mp),
        width: J(Yn)
    }), Zp = M(Hp, {
        LineString: Dm(Up),
        ...
        Point: Dm(aq),
        Polygon: Dm(bq)
    }), pq = M(Gp, {Track: Dm(Sp)}), rq = M(Hp, {
        ExtendedData: fq, Link: function (a, b) {
            Lm(qq, a, b)
        }, address: J(S), description: J(S), name: J(S), open: J(Vn), phoneNumber: J(S),
        visibility: J(Vn)
    }), qq = M(Hp, {href: J(Op)}), kq = M(Hp, {LinearRing: Em(Qp)}), sq = M(Hp, {
        Style: J(dq),
        key: J(S),
        styleUrl: J(Op)
    }), uq = M(Hp, {
        ...
        }, "geometry"), Track: J(Sp, "geometry")
    })), vq = M(Hp, {color: J(Mp), fill: J(Vn), outline: J(Vn)}), iq = M(Hp, {
        ...
        IconStyle: function (a, b) {
            ...
            c && (b[b.length - 1].textStyle = new pp({
                fill: new wi({color: "color" in c ? c.color : sp}),
                scale: c.scale
            }))
            ...
            if (c) {
                var d = b[b.length - 1];
                d.fillStyle = new wi({color: "color" in c ? c.color : sp});
                var e = c.fill;
                void 0 !== e && (d.fill = e);
                c = c.outline;
                void 0 !== c && (d.outline =
    ...
    function xq(a, b) {
        var c;
        for (c = b.firstElementChild; c; c = c.nextElementSibling)if (Za(Hp, c.namespaceURI) && "name" == c.localName)return S(c);
    ...
    function zq(a, b) {
        var c, d = [];
        for (c = b.firstElementChild; c; c = c.nextElementSibling)if (Za(Hp, c.namespaceURI) && "NetworkLink" == c.localName) {
            var e = N({}, rq, c, []);
            d.push(e)
        }
    ...
    var Vq = M(Hp, ["Document", "Placemark"]), Yq = M(Hp, {
        Document: L(function (a, b, c) {
            Mm({node: a}, Wq, Xq, b, c, void 0, this)
        }), Placemark: L(Kq)
    }), Wq = M(Hp, {Placemark: L(Kq)}), Zq = {
        Point: "Point",
    ...
    }, $q = M(Hp, ["href"], M(Gp, ["x", "y", "w", "h"])), ar = M(Hp, {href: L(co)}, M(Gp, {
        x: L(eo),
        y: L(eo),
        w: L(eo),
        h: L(eo)
        ...
        Icon: L(function (a, b, c) {
            a = {node: a};
            var d = $q[c[c.length - 1].node.namespaceURI], e = Km(b, d);
            Mm(a, ar, Jm, e, c, d);
            d = $q[Gp[0]];
            e = Km(b, d);
            Mm(a, ar, cr, e, c, d)
        }), heading: L(eo), hotSpot: L(function (a, b) {
            a.setAttribute("x", b.x);
            a.setAttribute("y", b.y);
            a.setAttribute("xunits", b.Wf);
            a.setAttribute("yunits", b.Xf)
        }), scale: L(Uq)
    }), er = M(Hp, ["color", "scale"]), fr = M(Hp, {
        color: L(Aq),
        scale: L(Uq)
    }), gr = M(Hp, ["color", "width"]), hr = M(Hp, {
        color: L(Aq),
        width: L(eo)
    }), Iq = M(Hp, {LinearRing: L(Nq)}), Gq = M(Hp, {
        LineString: L(Nq),
        Point: L(Nq), Polygon: L(Qq), GeometryCollection: L(Bq)
    }), Lq = M(Hp, "name open visibility address phoneNumber description styleUrl Style".split(" ")), Mq = M(Hp, {
        MultiGeometry: L(Bq),
        LineString: L(Nq),
        LinearRing: L(Nq),
        Point: L(Nq),
    ...
    }), kr = M(Hp, {color: L(Aq)}), ir = M(Hp, ["IconStyle", "LabelStyle", "LineStyle", "PolyStyle"]), jr = M(Hp, {
        IconStyle: L(function (a,
            ...
            b = Km({color: b.a, width: b.f}, d);
            Mm(a, hr, Jm, b, c, d)
        }), PolyStyle: L(function (a, b, c) {
            Mm({node: a}, kr, lr, [b.b], c)
        })
    });
            ...
            return function d(a, b, g) {
                ...
                1: [function (a, b, f) {
                    ...
                    f.write = function (a, b, d, e, f, p) {
                        var q, t = 8 * p - f - 1, u = (1 << t) - 1, y = u >> 1, x = 23 === f ? Math.pow(2, -24) - Math.pow(2, -77) : 0;
                        p = e ? 0 : p - 1;
                        var C = e ? 1 : -1, z = 0 > b || 0 === b && 0 > 1 / b ? 1 : 0;
                        b = Math.abs(b);
                    ...
                    f.prototype = {
                        If: function (a, b, d) {
                            ...
                            a &= 7;
                            if (a === f.f)for (; 127 < this.bc[this.ca++];); else if (a === f.b) this.ca = this.Ea() + this.ca; else if (a === f.a) this.ca += 4; else if (a === f.g) this.ca += 8; else throw Error("Unimplemented type: " + a);
                        }
                    }
                }, {ieee754: 1}]
            }, {}, [2])(2)
        ...
        (function (c) {
            ...
            return function d(a, b, g) {
                ...
                4: [function (a, b) {
                    ...
                    function g(a, b, d) {
                        if (1 == a) b.id = d.Ea(); else if (2 == a)for (a = d.Ea() + d.ca; d.ca < a;) {
                            var e = b.Kd[d.Ea()], f = b.Md[d.Ea()];
                            b.properties[e] = f
                    ...
                    f.prototype.Ng = function () {
                        var a = this.nc;
                        a.ca = this.Ne;
                        for (var b = a.Ea() + a.ca, d = 1, e = 0, f = 0, g = 0, u = [], y; a.ca < b;)if (e || (e = a.Ea(), d = e & 7, e >>= 3), e--, 1 === d || 2 === d) f += a.zd(), g += a.zd(), 1 === d && (y && u.push(y), y = []), y.push(new h(f, g)); else if (7 === d) y && y.push(y[0].clone()); else throw Error("unknown command " + d);
                        y && u.push(y);
                        return u
                    };
                    f.prototype.bbox = function () {
                        ...
                        b;)if (e || (e = a.Ea(), d = e & 7, e >>= 3), e--, 1 === d || 2 === d) f += a.zd(), g += a.zd(), f < h && (h = f), f > y && (y = f), g < x && (x = g), g > C && (C = g); else if (7 !== d)throw Error("unknown command " + d);
                        return [h, x, y, C]
                    }
                }, {"point-geometry": 1}],
                5: [function (a, b) {
    ...
    rr.prototype.Ha = function (a, b) {
        var c = this.f, d = new mr(a), d = new nr.Ui(d), e = [], f = this.b, g, h, l;
    ...
    var Dr = [null, "http://www.opengis.net/ows/1.1"], Cr = M(Dr, {
            ...
            Get: Fm(function (a, b) {
                var c = zr(a);
                return c ? N({href: c}, Or, a, b) : void 0
            }), Post: void 0
        }), Pr = M(Dr, {
            DCP: J(function (a, b) {
                return N({}, Nr, a, b)
            ...
            Operation: function (a, b) {
                var c = a.getAttribute("name"), d = N({}, Pr, a, b);
                d && (b[b.length - 1][c] = d)
            }
        }), Kr = M(Dr, {Voice: J(S), Facsimile: J(S)}), Or = M(Dr, {
            Constraint: Fm(function (a, b) {
                var c = a.getAttribute("name");
                return c ? N({name: c}, Jr, a, b) : void 0
            })
        }),
        Qr = M(Dr, {
    ...
    k.yd = function (a, b) {
        var c = Pc(this.a), d = Vr(a, c, this.b);
        Rr(d, d.length, c, d);
        c = cd(d, 0, d.length, c);
        ...
        if ("Topology" == a.type) {
            ...
            if (c) {
                ...
                for (l = f.length; h < l; ++h) {
                    var m = f[h], n = c, p = g, q = 0, t = 0, u, y, x;
                    y = 0;
    ...
    var hs = {"http://www.opengis.net/gml": {boundedBy: J(Tn.prototype.xe, "bounds")}};

    function gs(a, b) {
        var c = {}, d = ao(b.getAttribute("numberOfFeatures"));
    ...
    function ds(a) {
        for (a = a.firstChild; a; a = a.nextSibling)if (a.nodeType == Node.ELEMENT_NODE)return N({}, es, a, [])
    }

    var ls = {"http://www.opengis.net/wfs": {PropertyName: L(co)}};

    function ms(a, b) {
        var c = wm("http://www.opengis.net/ogc", "Filter"), d = wm("http://www.opengis.net/ogc", "FeatureId");
        c.appendChild(d);
    ...
    var ns = {
        "http://www.opengis.net/wfs": {
            Insert: L(function (a, b, c) {
                var d = c[c.length - 1], d = wm(d.featureNS, d.featureType);
                a.appendChild(d);
                ...
                if (void 0 !== e) {
                    ...
                    Mm({node: a, srsName: d.srsName}, ns, Hm("Property"), g, c);
                    ms(a, e)
                }
    ...
    var ps = {
        "http://www.opengis.net/wfs": {
            Query: L(function (a, b, c) {
                ...
                if (d = d.filter) g = wm("http://www.opengis.net/ogc", "Filter"), a.appendChild(g), Mm({node: g}, ps, Hm(d.Hb), [d], c)
            })
        }, "http://www.opengis.net/ogc": {
            And: L(os),
            Or: L(os),
    ...
    cs.prototype.C = function (a, b, c, d) {
        var e = [], f = wm("http://www.opengis.net/wfs", "Transaction");
    ...
    var zs = {
        Point: vs, LineString: ws, Polygon: xs, MultiPoint: function (a) {
            var b = [];
            a = a.je();
    ...
    k.Wn = function () {
        if (Es(this, 2)) {
            var a;
            if (2 == this.b.type)for (a = [this.Cf()]; Es(this, 5);)a.push(this.Cf()); else a = Ks(this);
            if (Es(this, 3))return a
        } else if (Fs(this))return [];
        throw Error(Gs(this));
    };
    ...
    function Js(a) {
        for (var b = [], c = 0; 2 > c; ++c) {
            var d = a.b;
            if (Es(a, 4)) b.push(d.value); else break
        }
    ...
    Ms.prototype.b = function (a) {
        ...
        return (a = N({version: this.version}, Ns, a, [])) ? a : null
    };
    function Os(a, b) {
        return N({}, Ps, a, b)
    }
    ...
    var Vs = [null, "http://www.opengis.net/wms"], Ns = M(Vs, {
        ...
        ContactPersonPrimary: J(function (a, b) {
            return N({}, bt, a, b)
        }), ContactPosition: J(S), ContactAddress: J(function (a, b) {
            return N({}, ct, a, b)
        }), ContactVoiceTelephone: J(S), ContactFacsimileTelephone: J(S), ContactElectronicMailAddress: J(S)
    }), bt = M(Vs, {ContactPerson: J(S), ContactOrganization: J(S)}), ct = M(Vs, {
        AddressType: J(S),
        Address: J(S),
        City: J(S),
        StateOrProvince: J(S),
        PostCode: J(S),
        Country: J(S)
    }), Zs = M(Vs, {Format: Dm(S)}), $s = M(Vs, {
        Name: J(S), Title: J(S), Abstract: J(S), KeywordList: J(Ts), CRS: Fm(S),
        EX_GeographicBoundingBox: J(function (a, b) {
            ...
            var b = [Zn(a.getAttribute("minx")), Zn(a.getAttribute("miny")), Zn(a.getAttribute("maxx")), Zn(a.getAttribute("maxy"))], c = [Zn(a.getAttribute("resx")), Zn(a.getAttribute("resy"))];
        ...
        }), Identifier: Fm(S), MetadataURL: Fm(function (a, b) {
            var c = Os(a, b);
            if (c)return c.type = a.getAttribute("type"),
                c
        }), DataURL: Fm(Os), FeatureListURL: Fm(Os), Style: Fm(function (a, b) {
            return N({}, ft, a, b)
        }), MinScaleDenominator: J(Yn), MaxScaleDenominator: J(Yn), Layer: Fm(function (a, b) {
            var c = b[b.length - 1], d = N({}, $s, a, b);
            if (d) {
    ...
    }), et = M(Vs, {Title: J(S), OnlineResource: J(zr), LogoURL: J(Ss)}), dt = M(Vs, {
        westBoundLongitude: J(Yn),
        eastBoundLongitude: J(Yn), southBoundLatitude: J(Yn), northBoundLatitude: J(Yn)
    }), Ys = M(Vs, {GetCapabilities: J(Qs), GetMap: J(Qs), GetFeatureInfo: J(Qs)}), Rs = M(Vs, {
        Format: Fm(S),
    ...
    }), ht = M(Vs, {Get: J(Os), Post: J(Os)}), ft = M(Vs, {
        Name: J(S),
        Title: J(S),
        Abstract: J(S),
        LegendURL: Fm(Ss),
        StyleSheetURL: J(Os),
        StyleURL: J(Os)
    }), Ps = M(Vs, {Format: J(S), OnlineResource: J(zr)}), Us = M(Vs, {Keyword: Dm(S)});
    ...
    var mt = [null, "http://www.opengis.net/wmts/1.0"], nt = [null, "http://www.opengis.net/ows/1.1"], kt = M(mt, {
            ...
            }), Format: Fm(S), TileMatrixSetLink: Fm(function (a, b) {
                return N({}, st, a, b)
            ...
            Title: J(S), Abstract: J(S), WGS84BoundingBox: J(function (a, b) {
                var c = N([], ut, a, b);
        ...
        }, M(nt, {Title: J(S), Identifier: J(S)})), st = M(mt, {TileMatrixSet: J(S)}),
        tt = M(mt, {Default: J(S), Value: Fm(S)}, M(nt, {Identifier: J(S)})), ut = M(nt, {
            LowerCorner: Dm(lt),
            UpperCorner: Dm(lt)
        }), qt = M(mt, {
            WellKnownScaleSet: J(S), TileMatrix: Fm(function (a, b) {
                return N({}, vt, a, b)
            })
        }, M(nt, {SupportedCRS: J(S), Identifier: J(S)})), vt = M(mt, {
            TopLeftCorner: J(lt),
    ...
    var At = "accuracy", Ft = "accuracyGeometry", Bt = "altitude", Ct = "altitudeAccuracy", Dt = "heading", zt = "position", xt = "projection", Et = "speed", yt = "tracking", Gt = "trackingOptions";
    ...
    k.Lg = function (a) {
        ...
        if (!this.c || !Hc(this.c, f)) {
            var h = qc("EPSG:4326"), l = f.D(), m = f.i, n = Lc(m, h, f), p = m[2], q = m[1], t = m[0], u = n[3], y = n[2], x = n[1], n = n[0];
            this.i = m[3];
            this.g = p;
            this.j = q;
            this.f = t;
    ...
    function Yt(a) {
        a = a ? a : {};
        Jg.call(this, {handleDownEvent: Zt, handleDragEvent: $t, handleUpEvent: au});
            ...
            return function d(a, b, g) {
                ...
                1: [function (a, b) {
                    function f(a, b, d, e, q) {
                        ...
                        for (q = q || h; e > d;) {
                            if (600 < e - d) {
                                var t = e - d + 1, u = b - d + 1, y = Math.log(t), x = .5 * Math.exp(2 * y / 3), y = .5 * Math.sqrt(y * x * (t - x) / t) * (0 > u - t / 2 ? -1 : 1);
                        ...
                        load: function (a) {
                            ...
                            for (var d = this.data, e = this.ob(a), f = [], g = [], h, l, m, n; d || f.length;) {
                                ...
                                if (d.Wa) {
                                    a:{
                                        m = a;
                                        var q = d.children, p = b;
                                        if (p) {
                                            for (var u = 0; u < q.length; u++)if (p(m, q[u])) {
                                                m = u;
                                                break a
                                            }
                                            m = -1
                            ...
                            l.Wa = !1;
                            l.height = e;
                            var f = Math.ceil(f / h), h = f * Math.ceil(Math.sqrt(h)), m, n, q;
                            for (x(a, b, d, h, this.Se); b <= d; b += h)for (n = Math.min(b + h - 1, d), x(a, b, n, f, this.Te), m = b; m <= n; m += f)q = Math.min(m + f - 1, n), l.children.push(this.ag(a, m, q, e - 1));
                            g(l, this.ob);
                            return l
                        },
                        Zi: function (a, b, d, e) {
    ...
    k.rd = function (a, b, c) {
        ...
        for (f = a.length; e < f; ++e) {
            ...
            }) || (this.W.call(this, g, b, c), d.Da(g, {extent: g.slice()}))
        }
    };
    k.mb = function (a) {
        var b = ea(a).toString();
    ...
    v(mu, Ka);
    var nu = "addfeature", su = "changefeature", pu = "clear", ou = "removefeature";

    function tu(a) {
        Jg.call(this, {handleDownEvent: uu, handleEvent: vu, handleUpEvent: wu});
        this.fa = null;
        this.u = !1;
    ...
    function Gu(a, b) {
        ...
        if (a.j) {
            ...
            if (d)for (var d = b.map, f = 0, g = e.length; f < g; f++) {
                var h = e[f], l = d.Ca(h), m = b.pixel, c = m[0] - l[0], l = m[1] - l[1];
    ...
    function Eu(a, b) {
        var c = b.coordinate;
        a.o = c;
        a.i === zu ? a.a = c.slice() : a.i === yu ? (a.a = [[c.slice(), c.slice()]], a.P = a.a[0]) : (a.a = [c.slice(), c.slice()], a.i === Fu && (a.P = a.a));
    ...
    var zu = "Point", Au = "LineString", yu = "Polygon", Fu = "Circle";
    ...
    function Mu(a) {
        ...
        Jg.call(this, {handleDownEvent: Nu, handleDragEvent: Ou, handleEvent: Pu, handleUpEvent: Qu});
        this.u = new E({
    ...
    function Pu(a) {
        if (!(a instanceof Uf))return !0;
        if (a.type == dg && !this.C) {
            var b = a.pixel, c = a.map, d = Tu(this, b, c);
            d || (d = c.Ja(b));
            Uu(this, d)
        }
        Kg.call(this, a);
    ...
    function Zu(a) {
        Jg.call(this, {handleDownEvent: $u, handleDragEvent: av, handleEvent: bv, handleUpEvent: cv});
    ...
    function $u(a) {
        ...
        var b = this.a;
        if (b) {
            var c = [], b = b.V().Y(), d = Ab([b]), d = fu(this.i, d), e = {};
            d.sort(lv);
    ...
    function ev(a, b, c) {
        ...
        var e = c.Ja(b), f = c.Ja([b[0] - a.S, b[1] + a.S]), g = c.Ja([b[0] + a.S, b[1] - a.S]), f = Ab([f, g]), f = fu(a.i, f);
        if (0 < f.length) {
            f.sort(d);
            var g = f[0].pa, h = sb(e, g), l = c.Ca(h);
        ...
        if (this.W && this.W.type != eg) {
            ...
            for (p in a) {
                ...
                d && (e = c, this.o = !0, e.ma(f), this.o = !1, f = [], void 0 !== h && (this.i.remove(h), f.push(h.pa[0])), void 0 !== m && (this.i.remove(m), f.push(m.pa[1])), void 0 !== h && void 0 !== m && (h = {
                    ...
                    index: l,
                    pa: f
                }, this.i.Da(Ab(h.pa), h)), nv(this, c, g, n.depth,
    ...
    v(gv, Ka);
    var hv = "modifystart", mv = "modifyend";

    function ov(a) {
        tg.call(this, {handleEvent: pv});
        a = a ? a : {};
    ...
    function pv(a) {
        ...
        if (e) {
            ...
            f.Sd(a.pixel, function (a, e) {
                if (this.j(a, e)) {
                    if (!b && !d || Za(g.a, a)) (c || d) && Za(g.a, a) && (h.push(a), f = ea(a), delete this.a[f]); else {
                        l.push(a);
                        var f = ea(a);
                        this.a[f] = e
                    }
    ...
    function tv(a) {
        Jg.call(this, {handleEvent: uv, handleDownEvent: gc, handleUpEvent: vv});
        a = a ? a : {};
    ...
    k.fh = function (a, b) {
        var c = b.Y(), d, e, f, g;
        d = 0;
        for (e = c.length - 1; d < e; ++d)f = c.slice(d, d + 2), g = {feature: a, pa: f}, this.a.Da(Ab(f), g)
    };
    k.um = function (a, b) {
        var c = b.Y(), d, e, f, g, h, l, m;
        g = 0;
    ...
    k.vm = function (a, b) {
        var c = b.Y(), d, e, f;
        e = 0;
        for (f = c.length; e < f; ++e)d = c[e], d = {feature: a, pa: [d, d]}, this.a.Da(b.D(), d)
    };
    k.wm = function (a, b) {
        var c = b.Y(), d, e, f, g, h, l, m, n, p, q;
        l = 0;
    ...
    function uv(a) {
        ...
        var f = Ab([f, c]), g = fu(this.a, f), h, f = !1, l = null;
        c = null;
        if (0 < g.length) {
            this.S = e;
            g.sort(this.Ka);
    ...
    v(Dv, Ka);
    var Ev = "translatestart", Gv = "translating", Fv = "translateend";
    ...
    function U(a) {
        ...
        this.l(function (a) {
            ...
            c || (c = [new yi({image: new jp({opacity: a, src: this.P})})], this.c[b] = c);
            return c
        }.bind(this));
    ...
    k.lf = function () {
        var a = this.hh(), b = this.tg(), c = a + b + 1, d = 2 * c, d = De(d, d);
    ...
    Mv.prototype.Bd = function () {
        ...
        this.g.forEach(function (b) {
            b && b.U() == jg && a.push({extent: this.c.Ia(b.ya), image: b.qb()})
        }, this);
        this.g.length = 0;
        if (0 === a.length) this.state = 3; else {
            var b = this.s[0], c = this.o.Va(b), d = "number" === typeof c ? c : c[0], c = "number" === typeof c ? c : c[1], b = this.o.Ga(b), e = this.c.Ga(this.j), f = this.o.Ia(this.s);
    ...
    function Wi(a, b, c, d, e) {
        b = a.qd(b);
        if (!b)return !1;
        for (var f = !0, g, h, l = d.ba; l <= d.da; ++l)for (var m = d.ea; m <= d.ha; ++m)g = a.Fb(c, l, m), h = !1, b.b.hasOwnProperty(g) && (g = b.get(g), (h = g.U() === jg) && (h = !1 !== e(g))), h || (f = !1);
        return f
    }
    ...
    k.vc = function (a, b, c, d, e) {
        if (this.f && e && !Hc(this.f, e)) {
            ...
            var h = this.f, l = this.pb(h), m = this.pb(e), n = Wv(this, c, e);
    ...
    v(bw, W);
    var cw = new le({html: '<a class="ol-attribution-bing-tos" href="http://www.microsoft.com/maps/product/terms.html">Terms of Use</a>'});
    ...
    bw.prototype.Z = function (a) {
        if (200 != a.statusCode || "OK" != a.statusDescription || "ValidCredentials" != a.authenticationResultCode || 1 != a.resourceSets.length || 1 != a.resourceSets[0].resources.length) Vj(this, "error"); else {
            ...
            if (c.imageryProviders) {
                ...
                a = c.imageryProviders.map(function (a) {
                    ...
                    return new le({html: b, tileRanges: c})
                });
                a.push(cw);
                this.qa(a)
            }
    ...
    function dw(a) {
        a = a || {};
        var b = void 0 !== a.projection ? a.projection : "EPSG:3857", c = void 0 !== a.tileGrid ? a.tileGrid : ke({
            extent: ie(b),
            maxZoom: a.maxZoom,
            minZoom: a.minZoom,
            tileSize: a.tileSize
    ...
    function lw(a) {
        Wj.call(this, {projection: a.projection, resolutions: a.resolutions});
        this.Z = void 0 !== a.crossOrigin ? a.crossOrigin : null;
    ...
    function mw(a) {
        var b = a.imageExtent, c = void 0 !== a.crossOrigin ? a.crossOrigin : null, d = void 0 !== a.imageLoadFunction ? a.imageLoadFunction : ck;
        Wj.call(this, {attributions: a.attributions, logo: a.logo, projection: qc(a.projection)});
                ...
                1: [function (a, b, f) {
                    ...
                    l.prototype.bg = function () {
                        if (0 === this.Ld && 0 < this.bd.length) {
                            var a = this.Pe = this.bd.shift(), b = a.xc[0].width, d = a.xc[0].height, e = a.xc.map(function (a) {
                    ...
                    l.prototype.dj = function () {
                        var a = this.Pe, b = this.Nd.length, d, e;
                        if (1 === b) d = new Uint8ClampedArray(this.Hc[0].buffer),
                            e = this.Hc[0].meta; else {
    ...
    tw.prototype.u = function (a, b) {
        this.B = new pr.Pi({operation: a, Yk: "image" === this.Aa, jo: 1, lib: b, threads: this.La});
        this.v()
    };
    function ww(a, b, c) {
        var d = a.s;
    ...
    function uw(a) {
        for (var b = a.length, c = Array(b), d = 0; d < b; ++d) {
            ...
            f instanceof Uv ? (f = new D({source: f}), g = new hk(f)) : f instanceof Wj && (f = new di({source: f}), g = new gk(f));
            c[e] = g
        }
        return c
    }
    ...
    v(yw, Ka);
    var zw = "beforeoperations", Aw = "afteroperations";

    function Bw(a) {
        var b = a.layer.indexOf("-"), b = Cw[-1 == b ? a.layer : a.layer.slice(0, b)], c = Dw[a.layer];
        dw.call(this, {
            attributions: Ew,
            cacheSize: a.cacheSize,
            crossOrigin: "anonymous",
    ...
    v(Bw, dw);
    var Ew = [new le({html: 'Map tiles by <a href="http://stamen.com/">Stamen Design</a>, under <a href="http://creativecommons.org/licenses/by/3.0/">CC BY 3.0</a>.'}), sw], Dw = {
    ...
    Fw.prototype.sc = function (a, b, c) {
        ...
        d || (d = this.pb(c));
        if (!(d.b.length <= a[0])) {
            var e = d.Ia(a, this.o), f = Wd(d.Va(a[0]), this.l);
            1 != b && (f = Vd(f, b, this.l));
    ...
    function Jw(a) {
        ...
        if (a.jsonp) Lv(a.url, this.oh.bind(this), this.me.bind(this)); else {
    ...
    function Kw(a) {
        Uv.call(this, {projection: qc("EPSG:3857"), state: "loading"});
        this.s = void 0 !== a.preemptive ? a.preemptive : !0;
        this.o = Qv;
        this.i = void 0;
        this.c = a.jsonp || !1;
        if (a.url)if (this.c) Lv(a.url, this.zf.bind(this), this.ne.bind(this)); else {
            var b = new XMLHttpRequest;
    ...
    function Nw(a) {
        if (0 == a.state)if (a.state = 1, a.T) Lv(a.s, a.ph.bind(a), a.$d.bind(a)); else {
            var b = new XMLHttpRequest;
    ...
    k.gn = function (a, b, c, d) {
        ...
        b = e.Yd(a, b);
        if (!(e.b.length <= b[0])) {
            var f = e.Ga(b[0]), g = e.Ia(b, this.Z), e = Wd(e.Va(b[0]), this.l), h = this.u;
    ...
    k.sc = function (a, b, c) {
        ...
        if (!(d.b.length <= a[0])) {
            ...
            var e = d.Ga(a[0]), f = d.Ia(a, this.Z), d = Wd(d.Va(a[0]), this.l), g = this.u;
    ...
    function Xw(a, b) {
        ...
        a.TileMatrix.forEach(function (a) {
            d.push(a.Identifier);
            var b = 2.8E-4 * a.ScaleDenominator / l, h = a.TileWidth, t = a.TileHeight;
    ...
    function Y(a) {
        ...
        var d = this.W = void 0 !== a.requestEncoding ? a.requestEncoding : Yw, e = a.tileGrid, f = {
            layer: this.C,
            style: this.P,
            tilematrixset: this.o
        };
        d == Yw && ua(f, {Service: "WMTS", Request: "GetTile", Version: this.Z, Format: this.u});
        var g = this.c, h = c && 0 < c.length ? Pv(c.map(b)) : Qv;
        W.call(this, {
            attributions: a.attributions,
            cacheSize: a.cacheSize,
            crossOrigin: a.crossOrigin,
    ...
    function $w(a) {
        ...
        f.reverse();
        var b = [0, -b[1], b[0], 0], b = new Zd({extent: b, origin: Wb(b), resolutions: f}), h = a.url;
        W.call(this, {
            attributions: a.attributions,
            cacheSize: a.cacheSize,
            crossOrigin: a.crossOrigin,
    ...
    dx.prototype.add = function (a, b, c, d, e) {
        ...
        for (h = this.a.length; g < h; ++g)if (f = this.a[g], f.width >= b + this.b && f.height >= c + this.b)return h = {
            ...
            width: f.width - b,
            height: f.height
        }, b = {x: f.x, y: f.y + d, width: b, height: f.height - d}, ex(this, a, c, b)) : (c = {
            x: f.x + b,
            y: f.y,
            width: f.width - b,
            height: d
        }, b = {x: f.x, y: f.y + d, width: f.width, height: f.height - d}, ex(this,
            a, c, b)), h;
        return null
    };
    function ex(a, b, c, d) {
    ...
    r("ol.animation.bounce", function (a) {
        var b = a.resolution, c = a.start ? a.start : Date.now(), d = void 0 !== a.duration ? a.duration : 1E3, e = a.easing ? a.easing : Md;
        return function (a, g) {
            if (g.time < c)return g.animate = !0, g.viewHints[0] += 1, !0;
            if (g.time < c + d) {
    ...
    r("ol.loadingstrategy.tile", function (a) {
        return function (b, c) {
            var d = a.wc(c), e = be(a, b, d), f = [], d = [d, 0, 0];
    ...
    r("ol.render.toContext", function (a, b) {
        var c = a.canvas, d = b ? b : {}, e = d.pixelRatio || gf;
    ...
    r("ol.source.WMTS.optionsFromCapabilities", function (a, b) {
        ...
        p = b.requestEncoding;
        p = void 0 !== p ? p : "";
        if ("OperationsMetadata" in a && "GetTile" in a.OperationsMetadata)for (var n = a.OperationsMetadata.GetTile.DCP.HTTP.Get, u = 0, y = n.length; u < y; ++u) {
            var x = db(n[u].Constraint, function (a) {
                return "GetEncoding" == a.name
            }).AllowedValues.Value;
            "" === p && (p = x[0]);
            if (p === Yw) Za(x, Yw) && t.push(n[u].href); else break
        }
    ...
    r("ol.interaction.Draw.createRegularPolygon", function (a, b) {
        return function (c, d) {
            var e = c[0], f = c[1], g = Math.sqrt(xb(e, f)), h = d ? d : wd(new Ht(e), a);
    ...
    r("ol.interaction.Draw.createBox", function () {
        return function (a, b) {
            var c = Ab(a), d = b || new B(null);
            d.ma([[Sb(c), Tb(c), Vb(c), Wb(c), Sb(c)]]);
            return d
        }
    });
