...
public class RnoLteInterferCalcTask {
	...
	public static class TaskInfo {
		...
		String d2Freq;// d2频点
		String sourceType;
		long matrixDataCollectId = 0; // 干扰矩阵文件ID
		long flowDataCollectId = 0; // 流量文件ID
		int  getMatrixType = 0; //已有干扰矩阵ID

		TaskInfo() {

		}

		public int getGetMatrixType() {
			return getMatrixType;
		}

		public void setGetMatrixType(int getMatrixType) {
			this.getMatrixType = getMatrixType;
		}
		...
		public boolean getIsUseFlow() {
			return isUseFlow;
		}

		public void setIsUseFlow(boolean isUseFlow) {
		...
		public String getIsImportMatrix() {
			return isImportMatrix;
		}

		public void setIsImportMatrix(String isImportMatrix) {
			this.isImportMatrix = isImportMatrix;
		}
		...
		public String toString() {
			return "TaskInfo [taskName=" + taskName + ", taskDesc=" + taskDesc + ", provinceId=" + provinceId
					...
					+ converType + ", relaNumerType=" + relaNumerType + ", lteCells=" + lteCells + ", isCheckNCell="
					+ isCheckNCell + ", isExportAssoTable=" + isExportAssoTable + ", isExportMidPlan=" + isExportMidPlan
					+ ", isExportNcCheckPlan=" + isExportNcCheckPlan + ", isImportMatrix=" + isImportMatrix
					+ ", isUseFlow=" + isUseFlow + ", isUseSf=" + isUseSf + ", ks=" + ks + ", sfFiles=" + sfFiles
					+ ", freqAdjType=" + freqAdjType + ", d1Freq=" + d1Freq + ", d2Freq=" + d2Freq + ", sourceType="
					+ sourceType + ", matrixDataCollectId=" + matrixDataCollectId + ", flowDataCollectId="
					+ flowDataCollectId + ", getMatrixType=" + getMatrixType + "]";
		}
	}
