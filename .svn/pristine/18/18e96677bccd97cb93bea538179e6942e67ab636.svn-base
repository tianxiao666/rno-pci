package com.hgicreate.rno.lteazimuthevaluation.datasource;
...
@Configuration
@MapperScan(basePackages = "com.hgicreate.rno.lteazimuthevaluation.mapper.oracle", sqlSessionFactoryRef = "oracleSqlSessionFactory")
