package com.iscreate.rno.microservice.pci.afp.properties;
...
public class RnoProperties {
	...
	private String localFlowFilePath;
	...
	public String getLocalFlowFilePath() {
		return localFlowFilePath;
	}

	public void setLocalFlowFilePath(String localFlowFilePath) {
		this.localFlowFilePath = localFlowFilePath;
	}
