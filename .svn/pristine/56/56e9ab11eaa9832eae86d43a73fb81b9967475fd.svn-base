...
import com.hgicreate.rno.model.AreaRectangle;
import com.hgicreate.rno.model.RnoMapLnglatRelaGps;
...
//				 System.out.println(tmp);
				...
				log.warn("转换baidu坐标(" + baiduLng + "," + baiduLat + ")为GPS坐标，第"+times+"次连接超时，"+error);
				}else{
					e.printStackTrace();
				}
			} finally{
	...
	private static String decode(String str) {
		return new String(base64codec.decode(str));
	}
