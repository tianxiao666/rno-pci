package com.iscreate.rnointerfermatrix.tool;
...
public class DateUtil {
	...
	private SimpleDateFormat sdf12 = new SimpleDateFormat("yyyy-MM-dd HH:mm");
	private SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy-MM-dd");

	private SimpleDateFormat sdf6 = new SimpleDateFormat("MM-dd-yyyy HH:mm:ss");
	private SimpleDateFormat sdf9 = new SimpleDateFormat("MM-dd-yyyy HH:mm");
	private SimpleDateFormat sdf7 = new SimpleDateFormat("MM-dd-yyyy");

	private SimpleDateFormat sdf3 = new SimpleDateFormat("yyyy/MM/dd");
	private SimpleDateFormat sdf8 = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	private SimpleDateFormat sdf10 = new SimpleDateFormat("yyyy/MM/dd HH:mm");

	private SimpleDateFormat sdf4 = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
	private SimpleDateFormat sdf11 = new SimpleDateFormat("MM/dd/yyyy HH:mm");
	private SimpleDateFormat sdf5 = new SimpleDateFormat("MM/dd/yyyy");
	...
	public Date priorityAssignedParseDate(String str, int priority) {
		Date date = null;
		try {
			SimpleDateFormat[] sdfs = { sdf1, sdf2, sdf3, sdf4, sdf5, sdf6, sdf7, sdf8, sdf9, sdf10, sdf11, sdf12,
					sdf20 };
	 ...
	 */
	public enum DateFmt {
		SDF1("yyyy-MM-dd HH:mm:ss", 0), SDF2("yyyy-MM-dd", 1), SDF3("yyyy/MM/dd", 2), SDF4("MM/dd/yyyy HH:mm:ss",
				3), SDF5("MM/dd/yyyy", 4), SDF6("MM-dd-yyyy HH:mm:ss", 5), SDF7("MM-dd-yyyy", 6), SDF8(
						"yyyy/MM/dd HH:mm:ss", 7), SDF9("MM-dd-yyyy HH:mm", 8), SDF10("yyyy/MM/dd HH:mm", 9), SDF11(
								"MM/dd/yyyy HH:mm", 10), SDF12("yyyy-MM-dd HH:mm", 11), SDF20("yyyy-MM-dd HH", 12);
		// 成员变量
		private String name;
		private int index;
