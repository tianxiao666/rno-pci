...
public class Page {
	...
	private int totalPageCnt = -1;// 总页数
	...
	public String toString() {
		return "Page [pageSize=" + pageSize + ", currentPage=" + currentPage + ", totalCnt=" + totalCnt
				+ ", totalPageCnt=" + totalPageCnt + ", forcedStartIndex=" + forcedStartIndex + "]";
	}
}
